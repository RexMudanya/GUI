...
class Ui_Dialog(object):
    ...
    def save_btn_func(self):
        ...
        fname,filter= QtGui.QFileDialog.getSaveFileName(self,'Save File','C:\\',"Image Files (*.jpg)")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWhatsThis(_translate("Dialog", "<html><head/><body><p><span style=\" font-weight:600;\">QR Code Generator</span></p></body></html>"))
